...
namespace CharlsShoes.DAL
{
    ...
    {
        public static string conString = "Server=DESKTOP-MQL05HR\\MSSQLSERVER01;Database=charlsdb;Trusted_Connection=true;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venta>(
                V =>
                {
                    ...
                    V.Property(v => v.folio).IsRequired();
            ...
            modelBuilder.Entity<VentaDetalle>(
                VD =>
                {
                    VD.HasKey(vd => vd.idVentaDetalle);
                    ...
                    VD.HasOne(vd => vd.venta).WithMany(v => v.ventasDetalle).HasForeignKey(vd => vd.idVenta);
            ...
            modelBuilder.Entity<Cliente>(
                C =>
                {
                    ...
                    C.Property(c => c.direccion).HasMaxLength(100).IsRequired(false);
                    C.Property(c => c.telefono).HasMaxLength(20).IsRequired(false);
